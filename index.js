 ...
 * 数据验证
 * @author ydr.me
 * @create 2014-11-22 14:58
 * @update 2014-12-16 20:22:36
 * @update 2015年03月07日16:31:59
 */
...
var types = 'string,number,email,url,boolean,array'.split(',');
var noop = function () {
    // ignore
};
var customRules = {};
 ...
 * });
 */
Validator.fn.registerRule = function (options, fn, isOverride) {
    var the = this;
 ...
 * @arguments  err 对象
 */
Validator.fn.validateAll = function (data, callback) {
    var the = this;
 ...
 * @arguments  err 对象
 */
Validator.fn.validateOne = function (data, callback) {
    var the = this;
    var findIndex = -1;
 ...
 * @private
 */
Validator.fn._validateOne = function (rule, data, callback) {
    var the = this;
